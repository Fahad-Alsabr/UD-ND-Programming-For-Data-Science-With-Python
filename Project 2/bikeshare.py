...
def load_data(city, month, day):
    ...
    """
    df = pd.read_csv(CITY_DATA[city]) # Loading data file into a dataframe.
...
def time_stats(df):
    ...
    df['month'] = df['Start Time'].dt.month # Extracting month from the Start Time column to create a month column
